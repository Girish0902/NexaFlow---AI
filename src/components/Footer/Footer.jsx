    ...
    <footer role="contentinfo" className="footer-section">
      <div className="footer-container">
        ...
        <div className="footer-col brand-col">
          <span className="footer-logo">NexaFlow</span>
          <p className="brand-desc">
            Next-generation AI platform for intelligent data automation, predictive pipelines, and workflow orchestration.
          </p>
          <div className="footer-socials">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <svg width="20" height="20" aria-hidden="true" fill="currentColor" viewBox="0 0 19 19">
            ...
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer" aria-label="Discord">
              <svg width="20" height="20" aria-hidden="true" fill="currentColor" viewBox="0 0 20 19">
            ...
            <a href="https://bluesky.app" target="_blank" rel="noopener noreferrer" aria-label="Bluesky">
              <svg width="20" height="20" aria-hidden="true" fill="currentColor" viewBox="0 0 16 17">
            ...
            <a href="https://nexaflow.ai" target="_blank" rel="noopener noreferrer" aria-label="NexaFlow website">
              <svg width="20" height="20" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="footer-bottom">
        <p className="copyright">&copy; 2026 NexaFlow AI. All rights reserved.</p>
        
        {/* Floating Scroll to Top button using chevron-up-solid.svg */}
        <button 
          ...
          title="Scroll to top"
        >
          <img src="/icons/chevron-up-solid.svg" alt="" aria-hidden="true" width="20" height="20" />
        </button>
      </div>
    </footer>
  );
